export const LOCAL_ASSETS = {
    ...
    piadas: {
        ...
        textos: [
            ...
            "Por que a planta não foi atendida no pronto-socorro? Porque só tinha médico de plantão.",
            "O que o tomate foi fazer no banco? Foi tirar o extrato.",
            "Por que o carpinteiro é o homem mais calmo do mundo? Porque ele vive na marcenaria (mar-de-faria... ok, essa foi profunda).",
            "O que o pagodeiro foi fazer na igreja? Cantar Pá-god.",
            "Como o Batman faz para abrir a porta? Ele bat-mão",
            "Por que a velhinha não usa relógio? Porque ela é uma senhora.",
            "Eu ia te contar uma piada sobre o vácuo... mas não tem nada lá.",
            "Qual é o café preferido do fotógrafo? O café expresso (com foco no grão).",
    ...
    fome: {
        ...
        textos: [
            ...
            "Cara, que fome!",
            "Minha barriga ta gritando hahaha",
            "Fome nível: perigoso.",
            "Cadê a comida, o lanche, a pizza, qualquer coisa?",
            "Minha pressão tá até caindo!",
